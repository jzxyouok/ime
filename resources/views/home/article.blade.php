...
<div class="pjax">
    <main id="main">
        ...
        <article class="post_article single">
            <section id="banner">
                <h1 class="post_title">微信彩蛋，隐藏的功能。</h1>
                <ul class="info">
                    <li>11月24日</li>
                    <li>暂无评论</li>
                </ul>
            </section>
            <p>彩蛋什么的最能让人感到惊喜了。最近，微信的彩蛋被频频曝出，通过输入特定的代码即可开启原本隐藏功能。博主整理了部分实用代码，望各位伙伴玩的开心。</p>
            <p><strong>//multiwebview</strong>：将微信聊天页和文章页拆分为两个任务卡片</p>
            <p>在任意聊天窗口输入//multiwebview并发送，聊天和文章页面就可以被拆分为两个任务，并能同时出现在多任务切换页面中。如果在看文章过程中来了微信消息，回复消息后再跳转回文章就方便多了。当然，该功能还需系统的支持，目前只适用于Android 5.0及以上版本的系统。</p>
            <p><strong>//switchnotificationstatus</strong>：让微信也支持浮动通知</p>
            <p>在微信任意聊天窗口输入//switchnotificationstatus并发送，即可让微信也支持浮动通知。不过该功能仅支持Android 5.x +和微信6.2测试版。</p>
        ...
        <div id="respond" class="comment-respond">
            <h3 id="reply-title" class="comment-reply-title">发表评论 <small><a rel="nofollow" id="cancel-comment-reply-link" href="/1388.html#respond" style="display:none;">取消回复</a></small></h3>				<form action="http://www.siryin.com/wp-comments-post.php" method="post" id="commentform" class="comment-form">
