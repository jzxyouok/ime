...
<div class="wrapper wrapper-full-page">
    <div class="full-page login-page" data-color="block" data-image="/Static/admin/images/full-screen-image-4.jpg">
                    ...
                    <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                        <form id="loginForm">
                            ...
                            <div class="card{{-- card-hidden--}}">
                                <div class="header text-center">{{ config('site.web_name') }}</div>
                                <div class="content">
                                ...
                                <div class="footer text-center">
                                    <button type="button" class="btn btn-fill btn-warning btn-wd">登陆</button>
                                </div>
                            </div>
